...
ess_raw$fborn = ifelse(ess_raw$fborn == 1, 0, 1) # now 0 = born in the country, 1 = foreign born
...
ess_h.fborn = ess_l.fborn %>% mutate(
  poli.gap = polintr - mean.poli, 
  employ.gap = employ - mean.employ,
  hincfel.gap = hincfel - mean.hincfel, 
  ppltrst.gap = ppltrst - mean.ppltrst,
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Political interests by CIVIX in EU-15, foreign-borns', fig.height=1.5}
