...
ess_2002 = ess_2002 %>% 
  select(essround, cntry, agea, blgetmg, ctzcntr, livecntr, cntbrth, gndr, edulvla, facntr, mocntr, polintr, hincfel, uempla, ppltrst, pplfair) %>%
  plyr::rename(c("cntbrth"="birthplace","blgetmg"="ethnic", "edulvla"="edu"))
ess_2004 = ess_2004 %>% 
  select(essround, cntry, agea, blgetmg, ctzcntr, livecntr, cntbrtha, gndr, edulvla, facntr, mocntr, polintr, hincfel, uempla, ppltrst, pplfair) %>%
  plyr::rename(c("cntbrtha"="birthplace","blgetmg"="ethnic", "edulvla"="edu"))
ess_2006 = ess_2006 %>% 
  select(essround, cntry, agea, blgetmg, ctzcntr, livecntr, cntbrtha, gndr, edulvla, facntr, mocntr, polintr, hincfel, uempla, ppltrst, pplfair) %>%
  plyr::rename(c("cntbrtha"="birthplace","blgetmg"="ethnic", "edulvla"="edu"))
ess_2008 = ess_2008 %>% 
  select(essround, cntry, agea, blgetmg, ctzcntr, livecntr, cntbrthb, gndr, edulvla, facntr, mocntr, polintr, hincfel, uempla, ppltrst, pplfair) %>%
  plyr::rename(c("cntbrthb"="birthplace","blgetmg"="ethnic", "edulvla"="edu"))
ess_2010 = ess_2010 %>% 
  select(essround, cntry, agea, blgetmg, ctzcntr, livecnta, cntbrthb, gndr, edulvlb, facntr, mocntr, polintr, hincfel, uempla, ppltrst, pplfair) %>%
  plyr::rename(c("cntbrthb"="birthplace","blgetmg"="ethnic", "edulvlb"="edu","livecnta" = "livecntr"))
...
ess_raw = ess_nonciti %>% left_join(ess_mean, by='cntry')
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Political interests by CIVIX in EU-15 among Non-citizens', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Financial situation by CIVIX in EU-15 among Non-citizens', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Employment by CIVIX among Non-citizens', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='General trust by CIVIX in EU-15 among Non-citizens', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='People being fair by CIVIX in EU-15 among Non-citizens', fig.height=1.5}
...
polintr.l.1 = lm(polintr ~ agea + ethnic + female + edu + eubirth, data = ess_h.tenyr) # absolute level
polintr.l.2 = lm(poli.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.tenyr) # gap
...
hincfel.l.1 = lm(hincfel ~ agea + ethnic + female + edu + eubirth, data = ess_h.tenyr) # absolute level
hincfel.l.2 = lm(hincfel.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.tenyr) # gap
...
employ.l.1 = glm(employ ~ agea + ethnic + female + edu + eubirth, data = ess_h.tenyr, family = binomial(link = "logit")) # absolute level
employ.l.2 = lm(employ.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.tenyr) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Employment by CIVIX', fig.height=1.5}
employ.1 = as.data.frame(rbind(absolute.h, absolute.l, gap.h, gap.l))
colnames(employ.1) = c("intercept", "min", "max")
employ.1 = employ.1 %>% mutate(var = c('High CIVIX: Absolute Level', 'Low CIVIX: Absolute Level','High CIVIX: Gap w/Natives','Low CIVIX: Gap w/Natives'))
employ.1$var = factor(employ.1$var, as.character(employ.1$var))
...
ppltrst.l.1 = lm(ppltrst ~ agea + ethnic + female + edu + eubirth, data = ess_h.tenyr) # absolute level
ppltrst.l.2 = lm(ppltrst.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.tenyr) # gap
...
pplfair.l.1 = lm(pplfair ~ agea + ethnic + female + edu + eubirth, data = ess_h.tenyr) # absolute level
pplfair.l.2 = lm(pplfair.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.tenyr) # gap
