...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
polintr.h.1 = lm(polintr ~ agea + ethnic + female + edu + birthplace, data = ess_h.sec.immi) # absolute level
polintr.h.2 = lm(poli.gap ~ agea + ethnic + female + edu + birthplace, data = ess_h.sec.immi) # gap
polintr.l.1 = lm(polintr ~ agea + ethnic + female + edu + birthplace, data = ess_l.sec.immi) # absolute level
polintr.l.2 = lm(poli.gap ~ agea + ethnic + female + edu + birthplace, data = ess_l.sec.immi) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Political interests among 2nd generation by CIVIX', fig.height=3}
