...
dat$employment = ifelse(dat$`V229: Employment status` == 1, 1, 
                        ifelse(dat$`V229: Employment status` == 2, 0, NA)) # 1 = employed, 0 = unemployed
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Political interest by CIVIX (Non-EU)', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Political interest among 2nd generation by CIVIX (Non-EU)', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
trust1.h.1 = glm(trust1 ~ age + ethnic + gender + edu, data = h.civix, family = binomial(link = "logit")) # absolute level
trust1.h.2 = lm(trust1.gap ~ age + ethnic + gender + edu, data = h.civix) # gap
trust1.h.3 = glm(trust1 ~ age + ethnic + gender + edu, data = h.civix.sec, family = binomial(link = "logit")) # absolute level
trust1.h.4 = lm(trust1.gap ~ age + ethnic + gender + edu, data = h.civix.sec) # gap

trust1.l.1 = glm(trust1 ~ age + gender + edu, data = l.civix, family = binomial(link = "logit")) # absolute level
trust1.l.2 = lm(trust1.gap ~ age + gender + edu, data = l.civix)# gap
trust1.l.3 = glm(trust1 ~ age + gender + edu, data = l.civix.sec, family = binomial(link = "logit")) # absolute level
trust1.l.4 = lm(trust1.gap ~ age + gender + edu, data = l.civix.sec)# gap
```

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='General trust by CIVIX (Non-EU)', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='General trust among 2nd generation by CIVIX (Non-EU)', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Whether people are fair by CIVIX (Non-EU)', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Whether people are fair among 2nd generation by CIVIX (Non-EU)', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Household income by CIVIX (Non-EU)', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Household income among 2nd generation by CIVIX (Non-EU)', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
employment.h.1 = glm(employment ~ age + ethnic + gender + edu, data = h.civix, family = binomial(link = "logit")) # absolute level
employment.h.2 = lm(employment.gap ~ age + ethnic + gender + edu, data = h.civix) # gap
employment.h.3 = glm(employment ~ age + ethnic + gender + edu, data = h.civix.sec, family = binomial(link = "logit")) # absolute level
...
employment.l.3 = glm(employment ~ age + gender + edu, data = l.civix.sec, family = binomial(link = "logit")) # absolute level
employment.l.4 = lm(employment.gap ~ age + gender + edu, data = l.civix.sec)# gap
```

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Employment status by CIVIX (Non-EU)', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Employment status among 2nd generation by CIVIX (Non-EU)', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Financial situation by CIVIX (Non-EU)', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Financial situation among 2nd generation by CIVIX (Non-EU)', fig.height=1.5}
...
## First Generation Immigrants in ESS

```{r, echo=FALSE, message=FALSE, warning=FALSE}
polintr.h.1 = lm(polintr ~ agea + ethnic + female + edu + eubirth, data = ess_h.immi) # absolute level
polintr.h.2 = lm(poli.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.immi) # gap
polintr.l.1 = lm(polintr ~ agea + ethnic + female + edu + eubirth, data = ess_l.immi) # absolute level
polintr.l.2 = lm(poli.gap ~ agea + ethnic + female + edu + eubirth, data = ess_l.immi) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Political interests by CIVIX in EU-15', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
hincfel.h.1 = lm(hincfel ~ agea + ethnic + female + edu + eubirth, data = ess_h.immi) # absolute level
hincfel.h.2 = lm(hincfel.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.immi) # gap
hincfel.l.1 = lm(hincfel ~ agea + ethnic + female + edu + eubirth, data = ess_l.immi) # absolute level
hincfel.l.2 = lm(hincfel.gap ~ agea + ethnic + female + edu + eubirth, data = ess_l.immi) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Financial situation by CIVIX in EU-15', fig.height=1.5}
...
employ.h.1 = glm(employ ~ agea + ethnic + female + edu + eubirth, data = ess_h.immi, family = binomial(link = "logit")) # absolute level
employ.h.2 = lm(employ.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.immi) # gap
employ.l.1 = glm(employ ~ agea + ethnic + female + edu + eubirth, data = ess_l.immi, family = binomial(link = "logit")) # absolute level
employ.l.2 = lm(employ.gap ~ agea + ethnic + female + edu + eubirth, data = ess_l.immi) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Unemployment by CIVIX in EU-15', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
ppltrst.h.1 = lm(ppltrst ~ agea + ethnic + female + edu + eubirth, data = ess_h.immi) # absolute level
ppltrst.h.2 = lm(ppltrst.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.immi) # gap
ppltrst.l.1 = lm(ppltrst ~ agea + ethnic + female + edu + eubirth, data = ess_l.immi) # absolute level
ppltrst.l.2 = lm(ppltrst.gap ~ agea + ethnic + female + edu + eubirth, data = ess_l.immi) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='General trust by CIVIX in EU-15', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
pplfair.h.1 = lm(pplfair ~ agea + ethnic + female + edu + eubirth, data = ess_h.immi) # absolute level
pplfair.h.2 = lm(pplfair.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.immi) # gap
pplfair.l.1 = lm(pplfair ~ agea + ethnic + female + edu + eubirth, data = ess_l.immi) # absolute level
pplfair.l.2 = lm(pplfair.gap ~ agea + ethnic + female + edu + eubirth, data = ess_l.immi) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='People being fair by CIVIX in EU-15', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
polintr.h.1 = lm(polintr ~ agea + ethnic + female + edu + eubirth, data = ess_h.sec.immi) # absolute level
polintr.h.2 = lm(poli.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.sec.immi) # gap
polintr.l.1 = lm(polintr ~ agea + ethnic + female + edu + eubirth, data = ess_l.sec.immi) # absolute level
polintr.l.2 = lm(poli.gap ~ agea + ethnic + female + edu + eubirth, data = ess_l.sec.immi) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Political interests among 2nd generation by CIVIX in EU-15', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
hincfel.h.1 = lm(hincfel ~ agea + ethnic + female + edu + eubirth, data = ess_h.sec.immi) # absolute level
hincfel.h.2 = lm(hincfel.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.sec.immi) # gap
hincfel.l.1 = lm(hincfel ~ agea + ethnic + female + edu + eubirth, data = ess_l.sec.immi) # absolute level
hincfel.l.2 = lm(hincfel.gap ~ agea + ethnic + female + edu + eubirth, data = ess_l.sec.immi) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Financial situation among 2nd generation by CIVIX in EU-15', fig.height=1.5}
...
```{r, message=FALSE, warning=FALSE}
employ.h.1 = glm(employ ~ agea + ethnic + female + edu + eubirth, data = ess_h.sec.immi, family = binomial(link = "logit")) # absolute level
employ.h.2 = lm(employ.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.sec.immi) # gap
employ.l.1 = glm(employ ~ agea + ethnic + female + edu + eubirth, data = ess_l.sec.immi, family = binomial(link = "logit")) # absolute level
employ.l.2 = lm(employ.gap ~ agea + ethnic + female + edu + eubirth, data = ess_l.sec.immi) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Unemployment among 2nd generation by CIVIX in EU-15', fig.height=1.5}
employ.1 = as.data.frame(rbind(absolute.h, absolute.l, gap.h, gap.l))
colnames(employ.1) = c("intercept", "min", "max")
employ.1 = employ.1 %>% mutate(var = c('High CIVIX: Absolute Level', 'Low CIVIX: Absolute Level','High CIVIX: Gap w/Natives','Low CIVIX: Gap w/Natives'))
employ.1$var = factor(employ.1$var, as.character(employ.1$var))
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
ppltrst.h.1 = lm(ppltrst ~ agea + ethnic + female + edu + eubirth, data = ess_h.sec.immi) # absolute level
ppltrst.h.2 = lm(ppltrst.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.sec.immi) # gap
ppltrst.l.1 = lm(ppltrst ~ agea + ethnic + female + edu + eubirth, data = ess_l.sec.immi) # absolute level
ppltrst.l.2 = lm(ppltrst.gap ~ agea + ethnic + female + edu + eubirth, data = ess_l.sec.immi) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='General trust among 2nd generation by CIVIX in EU-15', fig.height=1.5}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
pplfair.h.1 = lm(pplfair ~ agea + ethnic + female + edu + eubirth, data = ess_h.sec.immi) # absolute level
pplfair.h.2 = lm(pplfair.gap ~ agea + ethnic + female + edu + eubirth, data = ess_h.sec.immi) # gap
pplfair.l.1 = lm(pplfair ~ agea + ethnic + female + edu + eubirth, data = ess_l.sec.immi) # absolute level
pplfair.l.2 = lm(pplfair.gap ~ agea + ethnic + female + edu + eubirth, data = ess_l.sec.immi) # gap
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='People being fair among 2nd generation by CIVIX in EU-15', fig.height=1.5}
